...
Fecha Fecha::operator +(int dias) const
{
	if(this->diaRel + dias <= 0)
		throw FechaInvalidaException("La fecha es inv�lida");
...
{
	if(this->diaRel + dias <= 0)
		throw FechaInvalidaException("La operaci�n += no se pudo realizar: La suma de los d�as dejar�an a la fecha inv�lida.");
