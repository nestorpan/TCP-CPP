...
:
	dni(Validaciones::validarMayorACero(dni, "DNI invalido")),
	apellido(Validaciones::validarLetrasYEspacios(apellido), "Apellido invalido"),
	nombre(Validaciones::validarLetrasYEspacios(nombre, "Nombre invalido")),
	sexo(Validaciones::sexo(), "Sexo invalido"),
	fNac(Validaciones::fechaMenorIgual(Validaciones::fechaMayorIgual(fNac, Fecha(1, 1, 1800), "Fecha Nac. muy antigua"), Fecha::hoy(), "Fecha Nac. futura")
{
